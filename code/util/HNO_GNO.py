...
class UNO3D(nn.Module):
    def __init__(self, in_width, width, pad=0, factor=3/4, pad_both=False):  # original factor is 1
        ...
        self.conv1 = OperatorBlock_3D(self.width, 2*factor*self.width, 48, 48, 48, 24, 24, 24)
        self.conv2 = OperatorBlock_3D(2*factor*self.width, 4*factor*self.width, 32, 32, 32, 16, 16, 16)
        self.conv3 = OperatorBlock_3D(4*factor*self.width, 8*factor*self.width, 16, 16, 16, 8, 8, 8)
        self.conv4 = OperatorBlock_3D(8*factor*self.width, 4*factor*self.width, 32, 32, 32, 8, 8, 8)
        self.conv5 = OperatorBlock_3D(8*factor*self.width, 2*factor*self.width, 48, 48, 48, 16, 16, 16)
        self.conv6 = OperatorBlock_3D(4*factor*self.width, 2*self.width, 64, 64, 64, 24, 24, 24) 
