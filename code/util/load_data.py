...
def get_chunk_data_surf(offset, chunk_size, NF, nx, ny, nz, in_channels, out_channels, inputpath, outputpath):
    data_in = torch.empty(chunk_size*NF, nx, ny, nz, in_channels)
    data_out = torch.empty(chunk_size*NF, nx, ny, 1, out_channels)
